...
class Funcionario
{
    ...
    {
        return "Seu nome é :  " .$this->nome." Sua cidade é: " .$this->cidade." Seu salario por horas trabalhadas são: ".$this->horasTrabalhadas.
        " Suas horas trabalhadas são: ".$this->horasTrabalhadas." E por fim seu salario final é: ".$this->salarioFinal;
